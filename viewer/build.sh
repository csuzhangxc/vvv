...
if ($rule == "deps") then
   ...
   if ($HOSTTYPE == "intel-mac") $make COMPILER="c++" OPTS="-O3 -Wall -Wno-parentheses" LINK="-Wl,-w -L/System/Library/Frameworks/OpenGL.framework/Libraries -framework GLUT -lobjc" TARGET=MACOSX $rule
endif
