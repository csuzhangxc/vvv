...
MACRO(FIND_VIEWER_LIBRARY name file path)
   IF (NOT ${name})
      IF (NOT VIEWER_BUILD_TYPE MATCHES DEBUG)
         FIND_LIBRARY(${name} ${file} PATHS ${path} PATH_SUFFIXES lib release minsizerel relwithdebinfo NO_DEFAULT_PATHS)
      ...
      ELSE (NOT VIEWER_BUILD_TYPE MATCHES DEBUG)
         FIND_LIBRARY(${name} NAMES ${file}d ${file} PATHS ${path} PATH_SUFFIXES lib debug NO_DEFAULT_PATHS)
...
MACRO(FIND_VIEWER_PATH name file path)
   IF (NOT ${name})
      FIND_PATH(${name} ${file} PATHS ${path} PATH_SUFFIXES include NO_DEFAULT_PATHS)
